						...
						<div class="module message"> <!--/.COMIENZO TAREAS-->
							...
							<div class="module-option clearfix">
								...
								<div class="pull-left">
									...
									<a href="proyectos.jsp?p_codigo=<%= request.getParameter("p_codigo")%>&p_titulo=<%= request.getParameter("p_titulo") %>&btnseccion=1" class="btn btn-primary">Añadir Seccion</a>
								</div>
							</div>
...
<div class="module message"> <!--/.COMIENZO TAREAS TABLA ABAJO-->
							...
							<div class="module-option clearfix">
								...
								<div class="pull-left">
									<a href="proyectos.jsp?p_codigo=<%= request.getParameter("p_codigo")%>&p_titulo=<%= request.getParameter("p_titulo")%>&se_codigo=<%=request.getParameter("se_codigo")%>&s_descripcion=<%= request.getParameter("s_descripcion") %>&btntareas=1" class="btn btn-primary">Añadir Tarea</a>
  ...
  %>       
										<tr class="task">
											...
											<td class="cell-status hidden-phone hidden-tablet"><a href="proyectos.jsp?p_codigo=<%=request.getParameter("p_codigo")%>&p_titulo=<%=request.getParameter("p_titulo")%>&se_codigo=<%=request.getParameter("se_codigo")%>&s_descripcion=<%= request.getParameter("s_descripcion") %>&ta_codigo=<%=codigota%>&ta_descripcion=<%=descripcionta%>&btn_editart=1"><b class="due">Editar</b></a></td>   
                                                                                        ...
                                                                                        <td class="cell-time align-right"><a href="comentarios.jsp?p_codigo=<%=request.getParameter("p_codigo")%>&p_titulo=<%=request.getParameter("p_titulo")%>&se_codigo=<%=request.getParameter("se_codigo")%>&s_descripcion=<%= request.getParameter("s_descripcion") %>&ta_codigo=<%=codigota%>&ta_descripcion=<%=descripcionta%>">Añadir/Ver</a></td>
