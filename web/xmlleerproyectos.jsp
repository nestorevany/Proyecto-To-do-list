...
<div id="myModal" class="modal"></div>
  ...
  <%
                    ...
                    String xml_path = getServletContext().getRealPath("proyectostest.xml");
                ...
                %>                                                                                     
                                            ...
                                            <tr class="odd gradeX">
                                   <td><%=proyectos.getAttributeValue("codigo_proyecto")%></td>
                                 <td><%=proyectos.getAttributeValue("titulo_proyecto")%></td>
