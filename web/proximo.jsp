...
<head>
		...
		<link rel="stylesheet" href="maruti/css/bootstrap.min.css" />
		<link rel="stylesheet" href="maruti/css/bootstrap-responsive.min.css" />
		<link rel="stylesheet" href="maruti/css/fullcalendar.css" />
		<link rel="stylesheet" href="maruti/css/maruti-style.css" />
		<link rel="stylesheet" href="maruti/css/maruti-media.css" class="skin-color" />
 ...
 //Thread.sleep(1000);
  ...
  %>      
                                            ...
                                            %>
                                             ...
                                             <a href="#"><input type="button" value="Añadir Proyecto" name="btnagregar" /></a> 
                                        </li>
						...
						<div class="widget-box widget-calendar">
                                ...
                                <div class="buttons">
									...
									<div class="modal hide" id="modal-add-event">
										...
										<div class="modal-footer">
											...
											<a href="#" id="add-event-submit" class="btn btn-primary">Agregar Tarea</a>
										</div>
									</div>
								</div>
							</div>
							<div class="widget-content">
								...
								<div id="external-events" class="panel-right">
									<div class="panel-title"><h5>Mover el Elemento al calendario para programar</h5></div>
									<div class="panel-content">
										<div class="external-event ui-draggable label label-inverse">Tarea 1</div>
                                        <div class="external-event ui-draggable label label-inverse">Tarea 2</div>
                                        <div class="external-event ui-draggable label label-inverse">Tarea 3</div>
                                        <div class="external-event ui-draggable label label-inverse">Tarea 4</div>
        ...
        <script src="maruti/js/jquery.min.js"></script>
            <script src="maruti/js/jquery.ui.custom.js"></script>
            <script src="maruti/js/bootstrap.min.js"></script>
            <script src="maruti/js/fullcalendar.min.js"></script>
            <script src="maruti/js/maruti.js"></script>
            <script src="maruti/js/maruti.calendar.js"></script>
