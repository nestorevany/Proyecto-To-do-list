...
<jsp:include page= "seguridad.jsp" flush="true"/> 
                        ...
                        <div class="content">
                            <div class="btn-controls">
                                <div class="btn-box-row row-fluid">
                                    <a href="graficos.jsp" class="btn-box big span4"><i class=" icon-bar-chart"></i><b></b>
                                        <p class="text-muted">
                                            Graficos</p>
                                    </a><a href="mapa.jsp" class="btn-box big span4"><i class="icon-globe"></i><b></b>
                                        <p class="text-muted">
                                            Mapas</p>
                                    </a><a href="xml.jsp" class="btn-box big span4"><i class="icon-laptop"></i><b></b>
                                        <p class="text-muted">
                                            XML</p>
                                    </a>
                                </div>
                                    ...
                                    <div class="span8">
                                        <div class="row-fluid">
                                            <div class="span12">
                                                ...
                                                </a><a href="usuarios.jsp" class="btn-box small span4"><i class="icon-group"></i><b>Usuarios</b>
                                                </a><a href="bitacoras.jsp" class="btn-box small span4"><i class="icon-exchange"></i><b>Actividades</b>
                                                </a>
                                            </div>
                                        </div>
                                        <div class="row-fluid">
                                            <div class="span12">
                                                <a href="webservices.jsp" class="btn-box small span4"><i class="icon-save"></i><b>Web Service</b>
                                    ...
                                    <table cellpadding="0" cellspacing="0" border="0" class="datatable-1 table table-bordered table-striped	 display"
                                        ...
                                        <tbody>
                                            <tr class="odd gradeX">
                                                ...
                                                <td>
                                                    Muestra un reporte de los usuarios activos
                                                </td>
                                                <td>
                                                    <a href="reporteusuarios.jsp">Ver</a>
                                                </td>
                                             ...
                                             <tr class="odd gradeX">
                                                ...
                                                <td>
                                                    Muestra cuantos proyectos ha creado cada usuario
                                                </td>
                                                <td>
                                                    <a href="reporteusuariosporpro.jsp">Ver</a>
                                                </td>
