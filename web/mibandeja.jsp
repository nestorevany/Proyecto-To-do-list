...
<div id="myModal" class="modal"></div>
						...
						<div class="module message"> <!--/.COMIENZO TAREAS-->
							...
							<div class="module-option clearfix">
								...
								<div class="pull-left">
									...
									<a href="mibandeja.jsp?btnseccion=1" class="btn btn-primary">Añadir Seccion</a>
								</div>
							</div>
  ...
  %>        
										<tr class="task">
											...
											<td class="cell-status hidden-phone hidden-tablet"><a href="mibandeja.jsp?s_codigo=<%=codigops%>&s_descripcion=<%=titulops%>&btn_editar=1"><b class="due">Editar</b></a></td>                                                                                        
                                                                                        <td class="cell-time align-right"><a href="mibandeja.jsp?s_codigo=<%=codigops%>&s_descripcion=<%=titulops%>&btn_tareas=1">Ver</a></td>                                                                     
...
<a href="mibandeja.jsp">Cancelar</a><div></div> 
  </form>      
<% } %>                                                            
...
<div class="module message"> <!--/.COMIENZO TAREAS TABLA ABAJO-->
							...
							<div class="module-option clearfix">
								...
								<div class="pull-left">
									<a href="mibandeja.jsp?s_codigo=<%=request.getParameter("s_codigo")%>&s_descripcion=<%= request.getParameter("s_descripcion") %>&btntareas=1" class="btn btn-primary">Añadir Tarea</a>
 ...
 <%
  ...
  %>      
										<tr class="task">
											...
											<td class="cell-status hidden-phone hidden-tablet"><a href="mibandeja.jsp?s_codigo=<%=request.getParameter("s_codigo")%>&s_descripcion=<%= request.getParameter("s_descripcion") %>&ta_codigo=<%=codigose%>&ta_descripcion=<%=descripcionse%>&btn_editart=1"><b class="due">Editar</b></a></td>   
...
<td class="cell-title"><a href="mibandeja.jsp?s_codigo=<%=request.getParameter("s_codigo")%>&s_descripcion=<%= request.getParameter("s_descripcion") %>">Cancelar</a><div></div></td> 
</tr>
<% } %>       									                                                       
...
<input type="submit" value="Editar" name="bt_agregar" />   
<a href="mibandeja.jsp?s_codigo=<%=request.getParameter("s_codigo")%>&s_descripcion=<%= request.getParameter("s_descripcion") %>">Cancelar</a><div></div> 
  </form>      
<% } %>      
