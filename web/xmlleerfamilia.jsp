...
<div id="myModal" class="modal"></div>
  ...
  <%
                    ...
                    String xml_path = getServletContext().getRealPath("")+"familia.xml";
                    Document bd_xml = builder.build(xml_path);
                    Element raiz = bd_xml.getRootElement();
                    
                    //recorrido en profundidad
                   //Element punto=raiz.getChild("Abuelo");
                    
                   //List lista_familia = punto.getChildren();
                    
                  // Element familia;

                   //for (int i = 0; i < lista_familia.size(); i++) {
                    //    familia = (Element) lista_familia.get(i);
                ...
                %>                                                                        
                                            <tr class="odd gradeX">
                    <td><%=familia.getName()%></td>  
                    <td><%=familia.getAttributeValue("abuelo")%></td>                                 
