...
<div id="myModal" class="modal"></div>
        ...
        <div class="span9">  <!--/.COMIENZO LAYOUT PRINCIPAL-->
             ...
             <h2>Lista de Graficos</h2>
             <h3>Proyectos por Usuarios</h3>
             <a href="grafpie.jsp">Grafico de Pastel</a><br>
             <a href="grafcolumna.jsp">Grafico de Barra</a><br>
             <a href="grafpunto.jsp">Grafico de Puntos</a>
             <br>
