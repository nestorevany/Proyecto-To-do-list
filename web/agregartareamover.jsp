 ...
 <%
  ...
  %>       
										<tr class="task">
											...
											<td class="cell-status hidden-phone hidden-tablet"><a href="movertarea.jsp?s_codigo=<%=codigose%>&ta_descripcion=<%=request.getParameter("ta_descripcion")%>&ta_codigo=<%=request.getParameter("ta_codigo")%>"><b class="due">Seleccionar</b></a></td>                                                                                        
                                                               
                                                                                       
                                                                                        <td class="cell-time align-right"><a href="mibandeja.jsp">Mi Bandeja</a></td>
										</tr>																														
                                     <%
                                                }
                                                db.desconectar();
