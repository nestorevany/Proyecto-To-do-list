...
<div id="myModal" class="modal"></div>
  ...
  <%
                    ...
                    String xml_path = getServletContext().getRealPath("tareastest.xml");
                  ...
                  for (int i = 0; i < lista_familia.size(); i++) {
                        proyectos = (Element) lista_familia.get(i);
                %>                                                                                     
                                   
                                            <tr class="odd gradeX">
                                   <td><%=proyectos.getAttributeValue("codigo_tarea")%></td>
                                 <td><%=proyectos.getAttributeValue("descripcion_tarea")%></td>
                                 <td><%=proyectos.getAttributeValue("seccion")%></td>
